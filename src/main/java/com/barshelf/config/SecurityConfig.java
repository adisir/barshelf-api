...
import com.barshelf.filter.JWTTokenGeneratorFilter;
import com.barshelf.filter.JWTTokenValidatorFilter;
        ...
        http.exceptionHandling(exceptionHandling -> exceptionHandling.accessDeniedHandler((request, response, accessDeniedException) -> {
                ...
                .cors(corsConfig -> corsConfig.configurationSource(new CorsConfigurationSource() {
                    ...
                    public CorsConfiguration getCorsConfiguration(HttpServletRequest request) {
                        ...
                        config.setAllowedOrigins(Collections.singletonList(env.getProperty("FRONTEND_URL")));
